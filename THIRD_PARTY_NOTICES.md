...
Selective Render Plots integrates with PlotSquared through its public Java API.
PlotSquared is a separate runtime dependency licensed under GPL-3.0 and is not
included in the Selective Render Plots JAR.
